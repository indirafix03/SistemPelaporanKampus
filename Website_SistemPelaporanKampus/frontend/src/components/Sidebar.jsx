...
export default function Sidebar({ role }) {
  ...
  return (
    <aside className="w-64 h-screen sticky top-0 bg-white border-r border-solid border-[#E5BDB8] flex flex-col pt-8 shrink-0 hidden md:flex justify-between">

      {/* Container Atas: Membungkus Logo & Menu Navigasi */}
      <div className="w-full flex flex-col flex-1 min-h-0">
        ...
        {/* Menu Navigasi Dinamis - Otomatis scroll mandiri jika menu melebihi tinggi layar */}
        <div className="w-full flex-1 px-4 flex flex-col gap-1.5 overflow-y-auto pb-4">
      ...
      {/* Tombol Logout - Terkunci permanen di bawah layar untuk Admin & Mahasiswa */}
