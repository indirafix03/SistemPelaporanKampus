...
export default function Login() {
    ...
    return ( <
        ...
        onClick = {
            () => setRole("mahasiswa") }
        className = { `flex-1 py-3 text-sm font-bold rounded border transition-all ${role === "mahasiswa" ? "bg-[#960006] text-white border-[#960006]" : "bg-[#FFF8F7] text-[#5C403C] border-[#E5BDB8]"}` } >
        Mahasiswa <
        /button> <
        button type = "button"
        onClick = {
            () => setRole("admin") }
        className = { `flex-1 py-3 text-sm font-bold rounded border transition-all ${role === "admin" ? "bg-[#960006] text-white border-[#960006]" : "bg-[#FFF8F7] text-[#5C403C] border-[#E5BDB8]"}` } >
        Admin <
        /button> <
        /div> <
        /div>
        ...
        { /* Alert Pesan Error */ } {
            error && ( <
                div className = "mb-4 bg-red-50 border border-red-200 text-red-600 p-3 rounded text-sm font-medium" > { error } <
                /div>
            )
        }

        <
        div className = "flex flex-col gap-5 mb-8" > { /* Input Email */ } <
        ...
        span className = "text-[#960006] text-sm font-bold hover:underline cursor-pointer" > Lupa Kata Sandi ? < /span> <
        /div> <
