        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between w-full gap-10">
          ...
          <div className="w-full lg:w-[460px] bg-white p-8 rounded-xl border border-solid border-[#E5BDB8] shadow-sm flex flex-col">
            ...
            <form onSubmit={handleLogin} className="flex flex-col text-left">
              ...
              {/* Alert Pesan Error */}
              {error && (
                <div className="mb-4 bg-red-50 border border-red-200 text-red-600 p-3 rounded text-xs font-medium">
                  {error}
                </div>
              )}
            ...
            <div className="mt-6 text-center w-full">
              <Link to="/register" className="text-[#5C403C] text-xs font-medium cursor-pointer hover:text-[#960006] hover:underline transition-colors">
