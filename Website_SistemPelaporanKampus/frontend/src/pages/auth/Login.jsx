...
export default function Login() {
    ...
    return ( <
        ...
        <
        img src = "https://storage.googleapis.com/tagjs-prod.appspot.com/v1/0HESghFleT/2h75xi3o_expires_30_days.png"
        ...
        <
        label className = "text-[#5C403C] text-xs font-bold" > Masuk Sebagai < /label> <
        div className = "flex gap-2 w-full" >
        <
        button type = "button"
        onClick = {
            () => setRole("mahasiswa") }
        className = { `flex-1 py-2 text-xs font-bold rounded border transition-all ${role === "mahasiswa" ? "bg-[#960006] text-white border-[#960006]" : "bg-[#FFF8F7] text-[#5C403C] border-[#E5BDB8]"}` } >
        Mahasiswa <
        /button> <
        button type = "button"
        onClick = {
            () => setRole("admin") }
        className = { `flex-1 py-2 text-xs font-bold rounded border transition-all ${role === "admin" ? "bg-[#960006] text-white border-[#960006]" : "bg-[#FFF8F7] text-[#5C403C] border-[#E5BDB8]"}` } >
        Admin <
        /button> <
        /div> <
        /div>
        ...
        { /* Alert Pesan Error */ } {
            error && ( <
                div className = "mb-4 bg-red-50 border border-red-200 text-red-600 p-3 rounded text-xs font-medium" > { error } <
                /div>
            )
        }

        <
        div className = "flex flex-col gap-4 mb-6" > { /* Input Email */ } <
        div className = "flex flex-col gap-1.5 w-full" >
        <
        label className = "text-[#5C403C] text-xs font-bold" > Alamat Email < /label> <
        div className = "flex items-center bg-[#FFF8F7] px-3 py-2.5 gap-3 rounded border border-solid border-[#E5BDB8] focus-within:border-[#960006] transition-all" >
        <
        ...
        <
        label className = "text-[#5C403C] text-xs font-bold" > Kata Sandi < /label> <
        span className = "text-[#960006] text-xs font-bold hover:underline cursor-pointer" > Lupa Kata Sandi ? < /span> <
        /div> <
        div className = "flex items-center bg-[#FFF8F7] px-3 py-2.5 rounded border border-solid border-[#E5BDB8] focus-within:border-[#960006] transition-all" >
        <
        ...
        <
        Link to = "/register"
        className = "text-[#5C403C] text-xs font-medium cursor-pointer hover:text-[#960006] hover:underline transition-colors" >
        ...
        <
        span className = "text-[#916F6A] text-xs font-bold" > ©2026 Sistem Pelaporan Fasilitas Kampus.Hak Cipta Dilindungi. <
        /span> <
