...
import unhasImage from "../../assets/unhas.png";
...
export default function Register() {
    ...
    return ( <
        div className = "flex flex-col bg-white min-h-screen font-sans antialiased" > { /* AREA UTAMA */ } <
        main className = "flex-1 flex items-center justify-center w-full max-w-[1200px] mx-auto px-6 py-8" >
        <
        div className = "flex flex-col lg:flex-row items-center lg:items-start justify-between w-full gap-10" > { /* SISI KIRI: BANNER INFORMASI */ } <
        ...
        <
        img src = "https://storage.googleapis.com/tagjs-prod.appspot.com/v1/0HESghFleT/96lc2ge5_expires_30_days.png"
        ...
        className = "flex flex-col gap-5 mb-8 text-left" > { /* Alert Pesan Error */ } {
            error && ( <
                div className = "bg-red-50 border border-red-200 text-red-600 p-3 rounded text-sm font-medium" > { error } <
                /div>
            )
        }
        ...
        <
        label className = "text-[#5C403C] text-sm font-bold" > Nama Lengkap < /label> <
        div className = "flex items-center bg-[#FFF8F7] px-4 py-3 gap-3 rounded border border-solid border-[#E5BDB8] w-full focus-within:border-[#960006] transition-all" >
        <
        input type = "text"
        name = "nama_lengkap"
        ...
        div className = "flex flex-col gap-1.5 w-full" >
        <
        label className = "text-[#5C403C] text-sm font-bold" > NIM / Nomor Identitas < /label> <
        div className = "flex items-center bg-[#FFF8F7] px-4 py-3 gap-3 rounded border border-solid border-[#E5BDB8] w-full focus-within:border-[#960006] transition-all" >
        <
        input type = "text"
        ...
        div className = "flex flex-col gap-1.5 w-full" >
        <
        label className = "text-[#5C403C] text-sm font-bold" > Email Kampus < /label> <
        div className = "flex items-center bg-[#FFF8F7] px-4 py-3 gap-3 rounded border border-solid border-[#E5BDB8] w-full focus-within:border-[#960006] transition-all" >
        <
        img src = "https://storage.googleapis.com/tagjs-prod.appspot.com/v1/0HESghFleT/o8nazz4l_expires_30_days.png"
        ...
        div className = "flex flex-col gap-1.5 w-full" >
        <
        label className = "text-[#5C403C] text-sm font-bold" > Buat Kata Sandi < /label> <
        div className = "flex items-center bg-[#FFF8F7] px-4 py-3 rounded border border-solid border-[#E5BDB8] w-full focus-within:border-[#960006] transition-all" >
        <
        img src = "https://storage.googleapis.com/tagjs-prod.appspot.com/v1/0HESghFleT/n5hwcfn7_expires_30_days.png"
        ...
        div className = "flex flex-col gap-1.5 w-full" >
        <
        label className = "text-[#5C403C] text-sm font-bold" > Konfirmasi Kata Sandi < /label> <
        div className = "flex items-center bg-[#FFF8F7] px-4 py-3 rounded border border-solid border-[#E5BDB8] w-full focus-within:border-[#960006] transition-all" >
        <
        img src = "https://storage.googleapis.com/tagjs-prod.appspot.com/v1/0HESghFleT/n5hwcfn7_expires_30_days.png"
        className = "w-4 h-5 mr-1 object-contain opacity-80"
        ...
        input type = "checkbox"
        id = "terms"
        className = "w-4 h-4 mt-0.5 rounded border-gray-300 text-[#960006] accent-[#960006] cursor-pointer"
        required /
        >
        <
        label htmlFor = "terms"
        className = "ml-2 text-[#5C403C] text-sm leading-normal cursor-pointer select-none" >
        Saya menyetujui { " " } <
        span className = "text-[#960006] font-bold hover:underline" >
        Syarat & Ketentuan <
        /span>{" "}
        serta { " " } <
        span className = "text-[#960006] font-bold hover:underline" >
        ...
        button type = "submit"
        disabled = { loading }
        className = { `w-full bg-[#960006] hover:bg-[#800005] text-white text-center py-3.5 rounded font-bold text-base transition-colors shadow-md ${
        ...
        <
        span className = "text-[#5C403C] text-sm font-medium" >
        Sudah memiliki akun ? { " " } <
        Link to = "/login"
        className = "text-[#960006] font-bold cursor-pointer hover:underline transition-colors" >
        Masuk di sini <
        /Link> < /
        span > <
        /div> < /
