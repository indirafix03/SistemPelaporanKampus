      ...
      <main className="flex-1 flex items-center justify-center w-full max-w-[1200px] mx-auto px-6 py-8">
        <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between w-full gap-10">
          ...
          <div className="w-full lg:w-[460px] bg-white p-10 rounded-xl border border-solid border-[#E5BDB8] shadow-sm flex flex-col">
            ...
            {/* Form Input Fields */}
            <form onSubmit={handleRegister} className="flex flex-col gap-5 mb-8 text-left">
              {/* Alert Pesan Error */}
              {error && (
                <div className="bg-red-50 border border-red-200 text-red-600 p-3 rounded text-sm font-medium">
                  {error}
                </div>
              )}
