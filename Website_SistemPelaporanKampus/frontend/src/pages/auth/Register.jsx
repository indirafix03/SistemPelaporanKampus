...
export default function Register() {
    ...
    return ( <
        ...
        className = "flex flex-col gap-5 mb-8 text-left" >
        ...
        button type = "submit"
        disabled = { loading }
        className = { `w-full bg-[#960006] hover:bg-[#800005] text-white text-center py-3.5 rounded font-bold text-base transition-colors shadow-md ${loading ? "opacity-50 cursor-not-allowed" : ""}` } >
